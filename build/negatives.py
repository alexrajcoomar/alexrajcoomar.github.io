...
CASES = [
    ...
    C("36", "light-strong-enough-to-matter", "the instrument light behind the globe is turned up until it takes the accent under the floor",
      lambda t: _edit(t, "site.css", "rgba(143,182,238,.095) 0%", "rgba(143,182,238,.5) 0%", 2)),
    C("36", "lamp-syntax-outside-the-parser", "the active Archival Light reading pool uses a browser-valid color-mix stop that the contrast parser cannot measure",
      lambda t: _edit(t, "site.css", "rgba(235,232,223,.8) 0%",
                      "color-mix(in srgb, rgba(235,232,223,.8) 100%, transparent) 0%")),
    ...
    C("36", "lamp-gradient-with-an-extra-layer", "a supported reading pool is followed by an unmeasured opaque gradient",
      lambda t: _edit(t, "site.css", "rgba(235,232,223,0) 88%);",
                      "rgba(235,232,223,0) 88%),linear-gradient(#fff,#fff);")),
