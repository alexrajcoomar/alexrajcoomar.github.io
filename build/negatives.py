...
CASES = [
    ...
    C("28", "placed-by-lattice", "documents are spread over the sphere by the old lattice instead of by origin and word rank",
      lambda t: _edit(t, "build/atlas.py", '    cents = {p["slug"]: centroid(*ranks[p["slug"]]) for p in order}\n',
